...
vi.mock("@/app/(app)/obrigacoes/baixa-actions", () => ({
  darBaixa: vi.fn(),
  reabrir: vi.fn(),
  alternarDispensa: vi.fn(),
  urlComprovante: vi.fn(),
}));
import { renderToStaticMarkup } from "react-dom/server";
import { Calendario } from "@/app/(app)/obrigacoes/Calendario";
import type { InstanciaView } from "@/app/(app)/obrigacoes/actions";

const inst: InstanciaView[] = [
  {
    id: "1",
    clienteNome: "ACME LTDA",
    obrigacaoNome: "PGDAS-D",
    obrigacaoCodigo: "PGDAS-D",
    periodicidade: "mensal",
    competencia: "2026-07-01",
    vencimentoLegal: "2026-08-20",
    vencimentoInterno: "2026-08-20",
    status: "pendente",
