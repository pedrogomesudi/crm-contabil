...
export async function prepararDanfse(competencia: string, limite = 12): Promise<ResultadoPreparo> {
  ...
  for (const n of notas) {
    ...
    await delay(500); // respira entre downloads para não saturar o ADN
  }
