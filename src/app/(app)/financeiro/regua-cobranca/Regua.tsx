      ...
      <section className="space-y-2">
        ...
        {etapas.map((e) => (
          <form
            ...
            className="grid grid-cols-[1fr_5rem_1fr_4rem_auto] items-center gap-2 rounded border border-linha p-2"
          >
            <input name="nome" defaultValue={e.nome} className="rounded border border-linha p-1" />
            <input name="dias_offset" type="number" defaultValue={e.dias_offset} className="rounded border border-linha p-1" title="dias (negativo=antes)" />
            <input name="template" defaultValue={e.template} className="rounded border border-linha p-1" />
        ...
        <form
          ...
          className="grid grid-cols-[1fr_5rem_1fr_4rem_auto] items-center gap-2 rounded border border-dashed border-linha p-2"
        >
          <input name="nome" placeholder="Nova etapa" className="rounded border border-linha p-1" />
          <input name="dias_offset" type="number" placeholder="dias" className="rounded border border-linha p-1" />
          <input name="template" placeholder="Mensagem com {nome} {valor} {vencimento} {dias}" className="rounded border border-linha p-1" />
