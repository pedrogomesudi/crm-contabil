...
export type ObrigacaoRow = { id: string; codigo: string; nome: string; esfera: string; periodicidade: string; aplicavelA: string[]; condicaoFlags: string[]; condicaoModo: string; ufs: string[]; cnaePrefixos: string[]; vencDia: number; vencMesOffset: number; vencMes: number | null; vencAnoOffset: number; prazoInternoDiasUteis: number; antecipa: boolean; comprovanteObrigatorio: boolean; ativa: boolean; ordem: number };
